...
[graph_rag.py](D:/Code/agent_learning/graph_rag.py).

## Project layout

- [graph_rag.py](D:/Code/agent_learning/graph_rag.py): CLI entrypoint
- [graph_rag_app](D:/Code/agent_learning/graph_rag_app): application code
...
If dependencies are genuinely missing, review [requirements.txt](D:/Code/agent_learning/requirements.txt)
...
GitHub Actions runs these commands from the repository root.
...
[runtime](D:/Code/agent_learning/runtime):

- [runtime/checkpoints.db](D:/Code/agent_learning/runtime/checkpoints.db)
- [runtime/logs/graph_rag.log](D:/Code/agent_learning/runtime/logs/graph_rag.log)
- `runtime/service-stdout.log`
- `runtime/service-stderr.log`

## Notes

- Use [agent](D:/Code/agent_learning/agent) for the local index directory.
- Use [runtime](D:/Code/agent_learning/runtime) for checkpoints and logs.
- Use `conda run -n langgraph` for project commands unless a task explicitly targets another environment.
- If a command depends on relative paths, run it from the repository root.
